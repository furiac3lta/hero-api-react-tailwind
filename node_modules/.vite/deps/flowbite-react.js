...
// node_modules/flowbite-react/lib/esm/components/ButtonGroup/ButtonGroup.js
...
// node_modules/flowbite-react/lib/esm/components/Button/Button.js
var ButtonComponent = (0, import_react9.forwardRef)(({ children, color = "info", disabled = false, gradientDuoTone, gradientMonochrome, href, label, outline = false, pill = false, fullSized, positionInGroup = "none", size: size2 = "md", className, ...props }, ref) => {
  var _a;
  const isLink = typeof href !== "undefined";
...
var DropdownComponent = ({ children, className, ...props }) => {
  ...
  const content = (0, import_react16.useMemo)(() => (0, import_jsx_runtime23.jsx)("ul", { className: theme2.content, children: import_react16.Children.map(children, attachCloseListener) }), [children, theme2]);
...
var Checkbox = (0, import_react17.forwardRef)(({ className, ...props }, ref) => {
...
// node_modules/flowbite-react/lib/esm/components/FormControls/FileInput/FileInput.js
var FileInput = (0, import_react18.forwardRef)(({ sizing = "md", helperText, color = "gray", className, ...props }, ref) => {
...
var Radio = (0, import_react19.forwardRef)(({ className, ...props }, ref) => {
...
var Select = (0, import_react20.forwardRef)(({ children, sizing = "md", shadow, helperText, addon, icon: Icon, color = "gray", className, ...props }, ref) => {
...
var Textarea = (0, import_react21.forwardRef)(({ shadow, helperText, color = "gray", className, ...props }, ref) => {
...
var TextInput = (0, import_react22.forwardRef)(({ sizing = "md", shadow, helperText, addon, icon: Icon, color = "gray", className, ...props }, ref) => {
...
var ToggleSwitch = ({ checked, disabled, label, name, onChange, className, ...props }) => {
  ...
  return (0, import_jsx_runtime40.jsxs)(import_jsx_runtime40.Fragment, { children: [name && checked && (0, import_jsx_runtime40.jsx)("input", { checked, hidden: true, name, readOnly: true, type: "checkbox", className: "sr-only" }), (0, import_jsx_runtime40.jsxs)("button", { "aria-checked": checked, "aria-labelledby": `${id}-flowbite-toggleswitch-label`, disabled, id: `${id}-flowbite-toggleswitch`, onClick: handleClick, onKeyPress: handleKeyPress, role: "switch", tabIndex: 0, type: "button", className: (0, import_classnames34.default)(theme2.base, theme2.active[disabled ? "off" : "on"], className), ...props, children: [(0, import_jsx_runtime40.jsx)("div", { className: (0, import_classnames34.default)(theme2.toggle.base, theme2.toggle.checked[checked ? "on" : "off"]) }), (0, import_jsx_runtime40.jsx)("span", { "data-testid": "flowbite-toggleswitch-label", id: `${id}-flowbite-toggleswitch-label`, className: theme2.label, children: label })] })] });
};
...
var ModalComponent = ({ children, show, root, popup, size: size2 = "2xl", position = "center", onClose, className, ...props }) => {
  const [parent, setParent] = (0, import_react25.useState)(root);
  const [container, setContainer] = (0, import_react25.useState)();
...
var NavbarContext = (0, import_react26.createContext)(void 0);
function useNavbarContext() {
  const context = (0, import_react26.useContext)(NavbarContext);
  if (!context) {
...
var NavbarComponent = ({ children, menuOpen, fluid = false, rounded, border, className, ...props }) => {
  const [isOpen, setIsOpen] = (0, import_react27.useState)(menuOpen);
  const theme2 = useTheme().theme.navbar;
...
// node_modules/flowbite-react/lib/esm/components/Sidebar/SidebarCollapse.js
var SidebarCollapse = ({ children, icon: Icon, label, className, ...props }) => {
...
var SidebarItem = ({ as: Component = "a", children, icon: Icon, active: isActive, label, labelColor = "info", className, ...props }) => {
  var _a;
  ...
  return (0, import_jsx_runtime61.jsx)(ListItem, { children: (0, import_jsx_runtime61.jsxs)(Component, { "aria-labelledby": `flowbite-sidebar-item-${id}`, className: (0, import_classnames54.default)(theme2.base, isActive && theme2.active, !isCollapsed && isInsideCollapse && theme2.collapsed.insideCollapse, className), ...props, children: [Icon && (0, import_jsx_runtime61.jsx)(Icon, { "aria-hidden": true, className: (0, import_classnames54.default)(theme2.icon.base, isActive && theme2.icon.active), "data-testid": "flowbite-sidebar-item-icon" }), isCollapsed && !Icon && (0, import_jsx_runtime61.jsx)("span", { className: theme2.collapsed.noIcon, children: (_a = children.charAt(0).toLocaleUpperCase()) != null ? _a : "?" }), !isCollapsed && (0, import_jsx_runtime61.jsx)(Children6, { children }), !isCollapsed && label && (0, import_jsx_runtime61.jsx)(Badge, { color: labelColor, "data-testid": "flowbite-sidebar-label", hidden: isCollapsed, children: label })] }) });
};
...
var TabsComponent = ({ children, style = "default", className, ...rest }) => {
  ...
  const tabs = (0, import_react35.useMemo)(() => import_react35.Children.map(children, ({ props }) => props), [children]);
